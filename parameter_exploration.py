...
def objective_autogluon(trial, X_train, y_train, X_test, y_test, target_feature):
    param_grid = {
...
def optimize_all_targets(target, X_train, y_train, X_test, y_test):
...
if __name__ == "__main__":
    ...
    #                    'HOUST', 'DSPI', 'DGS5', 'DGS10', 'AAA', 'BAA', 'WTISPLC', 'IMPGS', 'FGCE', 
    #                    'PCEPI', 'PCEPILFE', 'PAYEMS', 'UNRATE', 'INDPRO', 'CUMFNS', 'USREC']
    target_features = ['BAA', 'WTISPLC', 'IMPGS', 'FGCE', 
                    'PCEPI', 'PCEPILFE', 'PAYEMS', 'UNRATE', 'INDPRO', 'CUMFNS', 'USREC']
    for target in target_features:
        ...
        optimize_all_targets(target, X_train, y_train, X_test, y_test)
